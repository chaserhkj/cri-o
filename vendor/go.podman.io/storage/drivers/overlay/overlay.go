...
func (d *Driver) get(id string, disableShifting bool, options graphdriver.MountOpts) (_ string, retErr error) {
	...
	if err := idtools.MkdirAllAndChownNew(mergedDir, 0o700, idtools.IDPair{UID: upperRootUID, GID: upperRootGID}); err != nil && !os.IsExist(err) {
		return "", err
	}
	...
	if err := idtools.MkdirAllAs(diffDir, perms, upperRootUID, upperRootGID); err != nil {
